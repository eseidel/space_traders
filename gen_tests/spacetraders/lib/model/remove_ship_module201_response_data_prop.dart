...
@immutable
class RemoveShipModule201ResponseDataProp {
  const RemoveShipModule201ResponseDataProp({
    required this.agent,
    required this.cargo,
  ...
  factory RemoveShipModule201ResponseDataProp.fromJson(
    ...
    return RemoveShipModule201ResponseDataProp(
  ...
  static RemoveShipModule201ResponseDataProp? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return RemoveShipModule201ResponseDataProp.fromJson(json);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is RemoveShipModule201ResponseDataProp &&
        agent == other.agent &&
