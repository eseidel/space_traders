...
@immutable
class ExtractResourcesWithSurvey201ResponseDataProp {
  const ExtractResourcesWithSurvey201ResponseDataProp({
  ...
  factory ExtractResourcesWithSurvey201ResponseDataProp.fromJson(
    ...
    return ExtractResourcesWithSurvey201ResponseDataProp(
  ...
  static ExtractResourcesWithSurvey201ResponseDataProp? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ExtractResourcesWithSurvey201ResponseDataProp.fromJson(json);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is ExtractResourcesWithSurvey201ResponseDataProp &&
