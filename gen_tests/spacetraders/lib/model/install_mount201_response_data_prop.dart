...
@immutable
class InstallMount201ResponseDataProp {
  const InstallMount201ResponseDataProp({
    required this.agent,
    required this.cargo,
  ...
  static InstallMount201ResponseDataProp? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return InstallMount201ResponseDataProp.fromJson(json);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is InstallMount201ResponseDataProp &&
        agent == other.agent &&
