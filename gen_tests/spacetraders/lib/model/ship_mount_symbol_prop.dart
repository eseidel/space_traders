enum ShipMountSymbolProp {
  ...
  const ShipMountSymbolProp._(this.value);

  factory ShipMountSymbolProp.fromJson(String json) {
    return ShipMountSymbolProp.values.firstWhere(
      (value) => value.value == json,
      orElse: () =>
          throw FormatException('Unknown ShipMountSymbolProp value: $json'),
    );
  }

  /// Convenience to create a nullable type from a nullable json object.
  /// Useful when parsing optional fields.
  static ShipMountSymbolProp? maybeFromJson(String? json) {
    if (json == null) {
      return null;
    }
    return ShipMountSymbolProp.fromJson(json);
  }
