enum ShipFrameSymbolProp {
  ...
  const ShipFrameSymbolProp._(this.value);

  factory ShipFrameSymbolProp.fromJson(String json) {
    return ShipFrameSymbolProp.values.firstWhere(
      (value) => value.value == json,
      orElse: () =>
          throw FormatException('Unknown ShipFrameSymbolProp value: $json'),
    );
  }

  /// Convenience to create a nullable type from a nullable json object.
  /// Useful when parsing optional fields.
  static ShipFrameSymbolProp? maybeFromJson(String? json) {
    if (json == null) {
      return null;
    }
    return ShipFrameSymbolProp.fromJson(json);
  }
