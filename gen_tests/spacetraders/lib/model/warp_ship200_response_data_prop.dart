...
@immutable
class WarpShip200ResponseDataProp {
  ...
  static WarpShip200ResponseDataProp? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return WarpShip200ResponseDataProp.fromJson(json);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is WarpShip200ResponseDataProp &&
        nav == other.nav &&
        fuel == other.fuel &&
