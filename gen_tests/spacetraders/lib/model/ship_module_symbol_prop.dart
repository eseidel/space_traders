enum ShipModuleSymbolProp {
  ...
  const ShipModuleSymbolProp._(this.value);

  factory ShipModuleSymbolProp.fromJson(String json) {
    return ShipModuleSymbolProp.values.firstWhere(
      (value) => value.value == json,
      orElse: () =>
          throw FormatException('Unknown ShipModuleSymbolProp value: $json'),
    );
  }

  /// Convenience to create a nullable type from a nullable json object.
  /// Useful when parsing optional fields.
  static ShipModuleSymbolProp? maybeFromJson(String? json) {
    if (json == null) {
      return null;
    }
    return ShipModuleSymbolProp.fromJson(json);
  }
