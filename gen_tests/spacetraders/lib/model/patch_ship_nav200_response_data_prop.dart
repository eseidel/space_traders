...
@immutable
class PatchShipNav200ResponseDataProp {
  const PatchShipNav200ResponseDataProp({
    required this.nav,
    required this.fuel,
    List<ShipConditionEvent>? events,
  }) : events = events ?? const <ShipConditionEvent>[];

  factory PatchShipNav200ResponseDataProp.fromJson(Map<String, dynamic> json) {
    return PatchShipNav200ResponseDataProp(
  ...
  static PatchShipNav200ResponseDataProp? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return PatchShipNav200ResponseDataProp.fromJson(json);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is PatchShipNav200ResponseDataProp &&
        nav == other.nav &&
        fuel == other.fuel &&
