...
@immutable
class ExtractResources201ResponseDataProp {
  const ExtractResources201ResponseDataProp({
  ...
  factory ExtractResources201ResponseDataProp.fromJson(
    ...
    return ExtractResources201ResponseDataProp(
  ...
  static ExtractResources201ResponseDataProp? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return ExtractResources201ResponseDataProp.fromJson(json);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is ExtractResources201ResponseDataProp &&
