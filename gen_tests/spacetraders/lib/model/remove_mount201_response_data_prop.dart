...
@immutable
class RemoveMount201ResponseDataProp {
  const RemoveMount201ResponseDataProp({
    required this.agent,
    required this.cargo,
  ...
  static RemoveMount201ResponseDataProp? maybeFromJson(
    Map<String, dynamic>? json,
  ) {
    if (json == null) {
      return null;
    }
    return RemoveMount201ResponseDataProp.fromJson(json);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is RemoveMount201ResponseDataProp &&
        agent == other.agent &&
