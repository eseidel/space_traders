  ...
  group('renderSchema', () {
    ...
    test('array type with pod types', () {
      ...
      expect(
        ...
        'class Test {\n'
        '    Test(\n'
        '        { this.aString = const <String>[], this.aInt = const <int>[], this.aNumber = const <double>[], this.aBoolean = const <bool>[], List<DateTime>? aDateTime, List<Uri>? aUri, this.aArrayOfString = const <List<String>>[], this.aEnum = const <TestAEnumPropInner>[], List<dynamic>? aUnknown, \n'
        '         }\n'
        '    ): this.aDateTime = aDateTime ?? const <DateTime>[], this.aUri = aUri ?? const <Uri>[], this.aUnknown = aUnknown ?? const <dynamic>[];\n'
        '\n'
        '    factory Test.fromJson(Map<String, dynamic>\n'
        '        json) {\n'
        '        return Test(\n'
